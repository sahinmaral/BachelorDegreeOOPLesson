...
public class IODExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(IODDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new IODStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static IODDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static IODDateTimeConverter dateTimeConverter = new IODStandardDateTimeConverter();

    public IODExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public IODExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new IODMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=IODHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,IODExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=IODHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
