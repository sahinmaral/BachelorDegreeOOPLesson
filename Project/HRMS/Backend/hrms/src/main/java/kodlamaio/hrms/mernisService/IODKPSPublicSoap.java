...
public class IODKPSPublicSoap
{
    ...
    public IODKPSPublicSoap(){}

    public IODKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public IODKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        IODExtendedSoapSerializationEnvelope envelope= new IODExtendedSoapSerializationEnvelope(IODExtendedSoapSerializationEnvelope.VER11);
